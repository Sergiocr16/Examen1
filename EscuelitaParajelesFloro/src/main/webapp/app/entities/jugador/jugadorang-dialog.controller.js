(function() {
    ...
    JugadorAngDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Jugador', 'Responsable'];

    function JugadorAngDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Jugador, Responsable) {
        var vm = this;
